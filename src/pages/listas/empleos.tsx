...
import { useListasQuery, useSearchPage_JobPostDescriptionQuery, useFilterListLazyQuery } from "@/codegen/client";
        ...
        <div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                                ...
                                                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                                    <div className="sm:col-span-1">
                                                        ...
                                                        <dd className="mt-1 text-sm text-gray-900">
                                                            {data.puesto[0].empresa.nombreComercial}
                                                        </dd>
                                                    </div>
                                                    <div className="sm:col-span-1">
                                                        <dt className="text-sm font-medium text-gray-500">Vacante</dt>
                                                        <dd className="mt-1 text-sm text-gray-900">
                                                            {data.puesto[0].nombre}
                                                        </dd>
                                                    </div>
                                                    <div className="sm:col-span-1">
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-md">
                    <JobList puestos={filterData?.puesto ?? []} />
                </div>
            </div>
        </div>
    );
